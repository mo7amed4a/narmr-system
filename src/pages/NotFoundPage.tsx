...
export default function NotFoundPage({
  ...
  description=`عذرًا، لا يمكننا العثور على تلك الصفحة. ستجد الكثير لاستكشافه على الصفحة الرئيسية`,
  btn=true
}: {
  title?:string
  description?:string
  ...
  return (
    <section className=" w-full h-screen min-h-screen flex items-center">
