        ...
        <div className="mb-8">
          ...
          <div className="grid gap-6 lg:grid-cols-4">
            ...
            <div className="space-y-2">
              ...
              <Select>
                <SelectTrigger>
                  <SelectValue placeholder="مركز المنصور" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="mansour">مركز المنصور</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Select>
                <SelectTrigger>
                  <SelectValue placeholder="د / عبد الرحمن وجيه" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="dr-rahman">د / عبد الرحمن وجيه</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
