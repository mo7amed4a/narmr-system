...
export default function BookingBondOne({ onSubmit }: BookingBondOneProps) {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    // Assume first row's account_id and service_id for simplicity
    // Adjust if your API expects multiple accounts/services
